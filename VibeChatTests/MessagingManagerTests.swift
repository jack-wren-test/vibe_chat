...
//
//    func testCreateConversationInMessaging() {
//        let convData = ["uid": "testUid"]
//        MessagingManager.shared.createConversationInMessaging(convData)
//    }
//
//    func testFetchAllMessages() {
//
//        let waitForFetchAsync = expectation(description: "Async Expectation")
//        MessagingManager.shared.fetchAllMessages(forThread: threadId) { (messages) in
//
...
//        MessagingManager.shared.listenForMessages(onConversation: threadId) { (messages) in
//
//            // Test messages are sucessfully fetched
//            XCTAssertNotNil(messages)
//
